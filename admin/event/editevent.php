...
ECHO '<a class="nav-link bg-danger col-2 text-light" href="addevent.php">them su kiem moi</a>'; 
echo '<tr class=" border-bottom text-center">
        <th class=" border-end">id</th>
        <th class=" border-end">tieu de</th>
        <th class=" border-end">thoi gian</th>
        <th class=" border-end">dia diem</th>
...
while ($row = mysqli_fetch_array($rs))
{
	echo '<tr class="text-center">
			...
			<td class=" border" scope="col">'.$row['date'].'</td>
      <td class=" border" scope="col">'.$row['diadiem'].'</td>
